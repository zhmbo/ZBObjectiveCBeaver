...
- (NSString *)formatMessage:(NSString *)format
    ...
    for (NSString *phrase in phrases) {
        ...
        if ([phrase isEqualToString:@""]) continue;
...
- (NSString *)levelWord:(ZBLogLevel)level {
    ...
    switch (level) {
        case ZBLogLevelDebug: str = _levelString.debug; break;
        case ZBLogLevelInfo: str = _levelString.info; break;
        case ZBLogLevelWarning: str = _levelString.warning; break;
        case ZBLogLevelError: str = _levelString.error; break;
        case ZBLogLevelVerbose: str = _levelString.verbose; break;
        case ZBLogLevelAll: str = _levelString.all; break;
        default: break;
    }
...
- (NSString *)colorForLevel:(ZBLogLevel)level {
    ...
    switch (level) {
        case ZBLogLevelDebug: color = _levelColor.debug; break;
        case ZBLogLevelInfo: color = _levelColor.info; break;
        case ZBLogLevelWarning: color = _levelColor.warning; break;
        case ZBLogLevelError: color = _levelColor.error; break;
        case ZBLogLevelVerbose: color = _levelColor.verbose; break;
        case ZBLogLevelAll: color = _levelColor.all; break;
        default: break;
    }
